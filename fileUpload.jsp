...
<%	  
	...
	{  
		...
		//out.println("<br>File data : <br><br>**************************<br>" + (new String(dataBytes,startPos, (endPos - startPos))) + "<br><br>**************************"); 
                  ...
                  PreparedStatement pst=con.prepareStatement("update book_details set image=? where bookid=?");
                  pst.setString(1,finame);
                  pst.setString(2,bkid);
                 pst.executeUpdate();
                 out.println("<br><br><h3>Image inserted successfully</h3>");
                con.close();
	}  
	else  
	{  
